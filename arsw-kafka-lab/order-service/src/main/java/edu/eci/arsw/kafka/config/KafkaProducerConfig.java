...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, InventoryProcessedEvent> inventoryProducerFactory() {
        return new DefaultKafkaProducerFactory<>(producerConfigs());
    }

    @Bean
    public KafkaTemplate<String, InventoryProcessedEvent> inventoryKafkaTemplate() {
